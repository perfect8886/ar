...
@TableGenerator(name = "crawler_record_id", table = "CRAWLER_TABLE_GENERATOR", pkColumnName = "GGEN_NAME", valueColumnName = "GGEN_VALUE", pkColumnValue = "CRAWLER_RECORD_PK", allocationSize = 1)
public class RecordEntity implements Serializable {
	@Id
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "crawler_record_id")
	@Column(name = "IID")
	private int id;
