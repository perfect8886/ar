package dsp.ar.crawler.dao.hibernate;
...
public class CrawlerDaoHibernate extends HibernateDaoSupport implements
		ICrawlerDao {
	...
	public List<MovieEntity> findMovies(String name, List<String> actorName,
			List<String> typeName, List<String> directorName, final int start,
			final int limit) {
		final StringBuilder queryStr = new StringBuilder(
